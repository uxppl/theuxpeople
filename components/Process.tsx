...
export const Process = () => {
  ...
  return (
    <section
      className="max-w-[1180px] h-full mx-auto px-6 mt-20 pb-20 space-y-10"
      id="projects"
    >
      ...
      <div className="w-full flex flex-col items-center overflow-hidden">
        <div className="w-full overflow-x-auto z-50">
          <div className="flex min-w-[50rem] max-w-2xl w-full justify-between items-center  mx-auto mb-10 ">
            {steps.map((step, idx) => (
              <div
                key={step.name}
        ...
        <div className="w-full mx-auto bg-white rounded-3xl shadow-lg p-12 mb-10 h-full xl:h-[880px] flex flex-col items-center justify-between">
          <div className="w-full h-full gap-8 flex flex-col">
            ...
            <div className="mt-6 flex flex-col md:flex-row items-center justify-between">
              <div className="font-medium text-xl ml-4 mb-3 text-foreground w-64">
                You'll get
              </div>
              <div className="flex justify-between w-full flex-wrap gap-3">
                {processItems[activeStep]?.stack?.map((item, idx) => (
                  <div key={item.title} className="flex flex-col items-center">
                    ...
                    <span className="text-base text-center text-foreground  max-w-[100px]">
                      {item.title}
                    </span>
                  </div>
                ))}
          ...
          <div className="w-full flex justify-between items-center text-sm  text-sub-color font-medium z-50 mt-8 ">
            <button
